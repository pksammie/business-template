...
app.get('/decision-page', (req, res) => res.sendFile(path.join(__dirname, 'public', 'decision-page.html')));
app.get('/decision-page.html', (req, res) => res.sendFile(path.join(__dirname, 'public', 'decision-page.html')));
